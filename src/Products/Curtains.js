  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Beautiful curtains that elevate your space with premium fabric, design, and customization options."
        />
        <meta
          name="keywords"
          content="curtains, window curtains, home curtains, designer drapes"
        />

        {/* Canonical */}
        <link rel="canonical" href="https://indecdecors.com/products/curtains" />

        {/* Open Graph */}
        <meta property="og:title" content="Curtains | Indec Interiors" />
        <meta
          property="og:description"
          content="Premium blackout and sheer curtains crafted for elegance and comfort."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://indecdecors.com/image/curtains-drapes.jpg"
        />
      </Helmet>
        ...
        <section className="theme-section">
          <div className="container" data-aos="fade-up">
            <div className="theme-section-title text-center">
              <h2>Curtains</h2>
              <p>
                Premium curtains combining style, functionality, and comfort for your interiors.
              </p>
            </div>
