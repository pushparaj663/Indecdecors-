  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Elegant mosquito net doors that combine functionality with modern design for homes and offices."
        />
        <meta
          name="keywords"
          content="mosquito net doors, sliding mosquito doors, pleated mosquito doors, hinged mosquito doors, insect protection"
        />

        {/* Canonical */}
        <link rel="canonical" href="https://indecdecors.com/products/mosquitonetdoors" />

        {/* OpenGraph */}
        <meta property="og:title" content="Mosquito Net Doors | Indec Interiors" />
        <meta property="og:description" content="Safe, stylish, and functional mosquito net doors for your home." />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://indecdecors.com/image/products-door.jpg"
        />
      </Helmet>
